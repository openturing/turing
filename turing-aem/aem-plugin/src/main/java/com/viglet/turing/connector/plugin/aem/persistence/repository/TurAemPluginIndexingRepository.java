...
import com.viglet.turing.connector.plugin.aem.persistence.model.TurAemPluginIndexing;
...
public interface TurAemPluginIndexingRepository extends JpaRepository<TurAemPluginIndexing, String> {
    ...
    Optional<List<TurAemPluginIndexing>> findByAemIdAndIndexGroup(String aemId, String indexGroup);
