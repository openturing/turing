...
package com.viglet.turing.connector.plugin.aem.persistence;
...
public class TurAemIndexingDAO {
    ...
    public Optional<List<TurAemIndexing>> findByAemIdAndGroup(String id, String group) {
    ...
    private TypedQuery<TurAemIndexing> typedQueryByAemIdAndGroup(String id, String group) {
        CriteriaBuilder builder = entityManager.getCriteriaBuilder();
        CriteriaQuery<TurAemIndexing> criteria = builder.createQuery(TurAemIndexing.class);
        Root<TurAemIndexing> from = criteria.from(TurAemIndexing.class);
        criteria.select(from);
