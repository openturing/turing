...
public class TurOpenNLPModelsOnStartup {
	...
	public static void downloadModels() {
		...
		downloadModel(LOCALE_EN, "http://opennlp.sourceforge.net/models-1.5/en-ner-location.bin", "en-ner-location.bin");
		downloadModel(LOCALE_EN, "http://opennlp.sourceforge.net/models-1.5/en-ner-money.bin", "en-ner-money.bin");
		downloadModel(LOCALE_EN, "http://opennlp.sourceforge.net/models-1.5/en-ner-organization.bin", "en-ner-organization.bin");
		downloadModel(LOCALE_EN, "http://opennlp.sourceforge.net/models-1.5/en-ner-percentage.bin", "en-ner-percentage.bin");
		downloadModel(LOCALE_EN, "http://opennlp.sourceforge.net/models-1.5/en-ner-time.bin", "en-ner-time.bin");
		downloadModel(LOCALE_EN, "http://opennlp.sourceforge.net/models-1.5/en-parser-chunking.bin", "en-parser-chunking.bin");
		downloadModel(LOCALE_EN, "http://opennlp.sourceforge.net/models-1.5/en-pos-maxent.bin", "en-pos-maxent.bin");
		downloadModel(LOCALE_EN, "http://opennlp.sourceforge.net/models-1.5/en-pos-perceptron.bin", "en-pos-perceptron.bin");
		...
		downloadModel(LOCALE_PT, "http://opennlp.sourceforge.net/models-1.5/pt-pos-perceptron.bin", "pt-pos-perceptron.bin");
