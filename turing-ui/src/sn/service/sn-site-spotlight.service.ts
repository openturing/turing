...
export class TurSNSiteSpotlightService {
  ...
  public save(siteId: string, turSNSiteSpotlight: TurSNSiteSpotlight): Observable<Object> {
    return this.httpClient.put(`${environment.apiUrl}/api/sn/${siteId}/spotlight/${turSNSiteSpotlight.id}`,
