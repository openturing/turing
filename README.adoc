...
[preface]
image:https://img.shields.io/badge/Download-Release%20{viglet-version}-blue?style=for-the-badge&logo=Java[link="https://github.com/openturing/turing/releases/tag/v{viglet-version}""]
