...
image:https://img.shields.io/badge/Javadoc-Release%20{viglet-version}-orange?style=for-the-badge&logo=Java[link="https://openturing.github.io/turing/javadoc/"]
