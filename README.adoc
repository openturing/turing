...
== Development
=== Run
To run Viglet Turing, just execute the following line:
```shell
# Turing App
./gradlew turing-app:bootrun

# New UI using Angular 12 and Primer CSS
...
```
=== Docker Compose
You can start the Turing using MariaDB, Solr and Nginx
```shell
docker-compose up
```
...
* Semantic Navigation http://localhost:2700/sn/Sample.
