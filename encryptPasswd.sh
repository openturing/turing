...
EXECUTABLE_CLASS=com.viglet.turing.encrypt.TurEncryptCLI
BIN_DIR=`dirname $0`
DIST_DIR=$BIN_DIR
LIB_DIR=$DIST_DIR/build/libs
EXEC_CLASSPATH="."
...
echo "$JAVA_EXECUTABLE" -classpath $EXEC_CLASSPATH $EXECUTABLE_CLASS $SCRIPT_NAME "$@"
