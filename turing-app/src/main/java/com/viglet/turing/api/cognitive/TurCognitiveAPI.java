...
public class TurCognitiveAPI {
  ...
  public String turCognitiveDetectLanguage(
  ...
  public List<String> turCognitiveSpellChecker(
      @PathVariable String locale, @RequestParam(required = false, name = "text") String text) {
  ...
  private void createListWithFirstMatch(
      String text, List<String> suggesterPhrases, RuleMatch match) {
