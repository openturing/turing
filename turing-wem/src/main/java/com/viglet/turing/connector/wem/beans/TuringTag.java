...
public class TuringTag {
  ...
  public String toString() {
    return String.format(
        "tagName: %s, srcXmlName %s, srcAttrRelation: %s, srcAttrType: %s, className: %s,"
            + " mandatory: %s",
        this.getTagName(),
        this.getSrcXmlName(),
        this.getSrcAttributeRelation(),
        this.getSrcAttributeType(),
        this.getSrcClassName(),
        this.getSrcMandatory());
  }
